                    ...
                    <div class="page-header">
                        ...
                        <?php
                            foreach ($camp_list as $list) {
                                ...
                                echo "<li class='list-group-item'><b> Organisation Name: </b>" . $list['organisation_name'] . " </li><li class='list-group-item'><b>Camp_Head:  </b>".$list['camp_head']."</li><li class='list-group-item'><b>Contact Number: </b>".$list['phone_no']."</li><li class='list-group-item'><b>Email:  </b>".$list['email']."</li>";
