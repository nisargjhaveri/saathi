                ...
                <div class="col-lg-12">
                    ...
                    <form action="" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="password" name="conf_password" class="form-control" id="conf_password" placeholder="Password" required /><br>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-4">
                                <input class="btn-success btn btn-block" type="submit" name="signup" value="Register" />
                            </div>
                        </div>
                    </form>
